...
const content: GameContent = {
  ...
  recommendedSpecs: [
    {
      ...
      cpu: "3 vCPU",
      storage: "16 GB SSD",
      note: "Fine early on; expect memory use to grow with base count",
    },
    {
      ...
      cpu: "4 vCPU",
      storage: "20 GB SSD",
      note: "The template recommendation for a standard community world",
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "There are no forced wipes in Palworld — your world persists across patches, and SteamCMD updates keep the server on the current build (clients and server must match to connect). Major updates occasionally change balance or base mechanics, so take a manual backup before big patch days; if an update misbehaves, restore and hold the update until fixes land.",
    },
  ],
